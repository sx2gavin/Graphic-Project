...
mat2 = gr.material({0.5, 0.5, 0.5}, {0.5, 0.7, 0.5}, 5, 0)
-- mat3 = gr.material({1.0, 0.6, 0.1}, {0.5, 0.7, 0.5}, 5)

wall_mat = gr.material({0.765, 0.705, 0.482}, {0.5, 0.7, 0.5}, 0, 0)
desk_mat = gr.material({0.713, 0.608, 0.298}, {0.3, 0.3, 0.3}, 0, 0)

scene_root = gr.node('root')

s1 = gr.cone('s1', {-1, 0, 1}, {0, 0, 0}, 5, 2)
scene_root:add_child(s1)
s1:set_material(mat1)

s2 = gr.cylinder('s2', {0.5, 0, 1}, {2, -2, 0}, 5, 1)
...
white_light_1 = gr.light({0, 20.0, 20.0}, {0.5, 0.5, 0.5}, {4, 0, 0})
white_light_2 = gr.light({20.0, 0.0, 20.0}, {0.5, 0.5, 0.5}, {4, 0, 0})
