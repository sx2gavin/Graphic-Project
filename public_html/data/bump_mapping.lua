...
mat1 = gr.material({0.0, 0.0, 0.0}, {0.8, 0.8, 0.8}, 25, 0.3, 1.0, 1.52)
mat2 = gr.material({0.0, 0.0, 0.0}, {0.5, 0.7, 0.5}, 5, 0.0, 1.0, 1.5)
-- mat3 = gr.material({1.0, 0.6, 0.1}, {0.5, 0.7, 0.5}, 5)

wall_mat = gr.material({1.0, 1.0, 1.0}, {0.2, 0.2, 0.2}, 0, 0, 0, 0)
...
gr.render(scene_root, 'bump_mapping_3.png', 1024, 1024,
