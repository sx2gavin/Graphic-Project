...
mat1 = gr.material({1.0, 0.0, 0.0}, {0.8, 0.8, 0.8}, 25, 0.0, 0.0, 0.0)
...
white_light_2 = gr.light({100.0, 100.0, 0.0}, {0.0, 0.0, 0.0}, {2, 0, 0})

area_light_1 = gr.area_light({100.0, 100.0, 0.0}, {-1.0, 0, 1.0}, 20,  {1.0, -1.0, 1.0}, 20,  {0.9, 0.9, 0.9}, {2, 0, 0}) 

gr.render(scene_root, 'soft_shadow_1.png', 1024, 1024,
